...
"""autogenerated by genpy from myPackage/BadTwoIntsRequest.msg. Do not edit."""
import sys
...
class BadTwoIntsRequest(genpy.Message):
  ...
  _type = "myPackage/BadTwoIntsRequest"
...
def _get_struct_qi():
    ...
    return _struct_qi
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from myPackage/BadTwoIntsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class BadTwoIntsResponse(genpy.Message):
  ...
  _type = "myPackage/BadTwoIntsResponse"
  _has_header = False #flag to mark the presence of a Header object
