...
(cl:defmethod cl:initialize-instance :after ((m <BadTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BadTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myPackage-srv:<BadTwoInts-request> is deprecated: use myPackage-srv:BadTwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <BadTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myPackage-srv:a-val is deprecated.  Use myPackage-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <BadTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myPackage-srv:b-val is deprecated.  Use myPackage-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <BadTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BadTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myPackage-srv:<BadTwoInts-response> is deprecated: use myPackage-srv:BadTwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <BadTwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myPackage-srv:sum-val is deprecated.  Use myPackage-srv:sum instead.")
  (sum m))
