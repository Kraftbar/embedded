...
(cl:defmethod cl:initialize-instance :after ((m <HeaderString>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeaderString)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myPackage-msg:<HeaderString> is deprecated: use myPackage-msg:HeaderString instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HeaderString>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myPackage-msg:header-val is deprecated.  Use myPackage-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <HeaderString>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myPackage-msg:data-val is deprecated.  Use myPackage-msg:data instead.")
  (data m))
