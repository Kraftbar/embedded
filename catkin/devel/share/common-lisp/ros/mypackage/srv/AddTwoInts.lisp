...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mypackage-srv:<AddTwoInts-request> is deprecated: use mypackage-srv:AddTwoInts-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mypackage-srv:<AddTwoInts-response> is deprecated: use mypackage-srv:AddTwoInts-response instead.")))
